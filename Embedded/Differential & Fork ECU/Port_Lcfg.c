...
const Port_ConfigType Port_ConfigPtr = {
		...
		PORT_PortA , PORT_Pin2, PORT_PIN_OUT , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_SSI , OUT_CURRENT_NA,
		PORT_PortA , PORT_Pin3, PORT_PIN_IN  , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_SSI , OUT_CURRENT_NA,
		PORT_PortA , PORT_Pin4, PORT_PIN_OUT , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_SSI , OUT_CURRENT_NA,
		...
		PORT_PortB , PORT_Pin3, PORT_PIN_OUT , PULL_UP, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortB , PORT_Pin4, PORT_PIN_OUT, PULL_UP, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortB , PORT_Pin5, PORT_PIN_OUT, OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_PWM0 , OUT_CURRENT_NA,
		PORT_PortB , PORT_Pin6, PORT_PIN_OUT , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortB , PORT_Pin7, PORT_PIN_OUT , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		...
		PORT_PortD , PORT_Pin1, PORT_PIN_IN , PULL_UP, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortD , PORT_Pin2, PORT_PIN_IN , PULL_UP, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		...
		PORT_PortE , PORT_Pin1, PORT_PIN_IN , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortE , PORT_Pin2, PORT_PIN_IN , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_ADC , OUT_CURRENT_NA,
		PORT_PortE , PORT_Pin3, PORT_PIN_IN , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortE , PORT_Pin4, PORT_PIN_IN, OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
		PORT_PortE , PORT_Pin5, PORT_PIN_IN , OPEN_DRAIN, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , OUT_CURRENT_NA,
